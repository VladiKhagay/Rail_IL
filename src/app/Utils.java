 ...
 * and checking the integrity of the input
 */
public abstract class Utils {
     ...
     * @param s
     * @return boolean
     * Given a String s , this method checks if the string contains digits only
     */
    ...
    /**
     * @param instruction
     * @return This method get an "instruction" String, the tells the user which input he should enter.
     * Then the method reads the user's input.
     * if the input is valid the method returns the user's input in a string
     */
     ...
     * @return LocalTime
     * <p>
     * This method get an "instruction" String, the tells the user which input he should enter.
     * Then the method reds the user's input.
     * If the input is valid, the method returns a LocalTime object that contains the user info.
     */
     ...
     * @return boolean
     * <p>
     * This method examines whether the user's input is in a valid format or not.
     * The desired format is: (HH: MM) 24 hours
     */
